  ...
  <div class="content">
    <div class="main" v-show="!showWrite">
      <el-form :model="Query">
        <el-row>
          <el-col :span="18">
            ...
            <el-col :span="8">
              <el-form-item label-width="125px" label="网络设备类型：">
      ...
      <el-table :data="tableData" v-loading="Loading" style="margin-top: 15px;">
        ...
        <el-table-column prop="networkequipmenttypename" label="网络设备类型" width=""></el-table-column>
    ...
    <div class="write" v-if="showWrite">
      <layuiTitle :title="WriteState === 0 ? '添加网络设备' : WriteState === 1 ? '修改网络设备' : '网络设备详情'"></layuiTitle>
...
import Details from 'base/ZYResource/OperatorEquipment'
