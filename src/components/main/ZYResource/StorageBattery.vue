  ...
  <div class="content">
    <div class="main" v-show="!showWrite">
      ...
      <el-table :data="tableData" v-loading="Loading" style="margin-top: 15px;">
        ...
        <el-table-column prop="batterytypename" label="电池类型" width=""></el-table-column>
    ...
    <div class="write" v-if="showWrite">
      <layuiTitle :title="WriteState === 0 ? '添加蓄电池' : WriteState === 1 ? '修改蓄电池' : '蓄电池详情'"></layuiTitle>
...
export default {
  ...
  methods: {
    ...
    getTable1 () {
      this.Loading = true
      this.$axios.get(GetStorageBatteryList, {
        params: {
          PageIndex: 1,
