  ...
  <div class="content">
    <div class="main" v-show="!showWrite">
      <el-form :model="Query">
        <el-row>
          <el-col :span="18">
            ...
            <el-col :span="8">
              <el-form-item label-width="125px" label="机房类型：">
      ...
      <el-table :data="tableData" v-loading="Loading" style="margin-top: 15px;">
        ...
        <el-table-column prop="computerroomtypename" label="机房类型" width=""></el-table-column>
    ...
    <div class="write" v-if="showWrite">
      <layuiTitle :title="WriteState === 0 ? '添加机房' : WriteState === 1 ? '修改机房' : '机房详情'"></layuiTitle>
...
import {GetComputerRoomList, GetComputerRoomExcel} from 'api/SurveyManagement'
import {exportMethod} from 'api/YDSZ'
import {formatDate} from 'common/js/cache'
import {GlobalRes} from 'common/js/mixins'
import layuiTitle from 'base/layui-title'
import ImgBox from 'base/ImgBox'
import Details from 'base/ZYResource/ComputerRoom'
...
export default {
  ...
  methods: {
    ...
    getDicList () {
      ...
      this.$axios.post(DictionaryInfoList, arr).then(res => {
        if (res.errorCode === '200') {
          this.DicList.powersupplymode = res.data.filter(i => { return i.type === '机房设备类型' })
        } else {
    ...
    getTable1 () {
      this.Loading = true
      this.$axios.get(GetComputerRoomList, {
        params: {
          PageIndex: 1,
