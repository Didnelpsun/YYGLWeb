  ...
  <div class="content">
    <div class="main" v-show="!showWrite">
      ...
      <el-table :data="tableData" v-loading="Loading" ref="table1" style="margin-top: 15px;">
        ...
        <el-table-column prop="sparemodel" label="备件型号" show-overflow-tooltip></el-table-column>
        <el-table-column prop="typename" label="备件类型" show-overflow-tooltip></el-table-column>
        <el-table-column prop="manufacturersname" label="厂家名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="remark" label="说明" show-overflow-tooltip></el-table-column>
        <el-table-column prop="realityname" label="提交人" width="80px"></el-table-column>
