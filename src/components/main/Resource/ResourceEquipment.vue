<template>
  <div class="content">
    ...
    <div class="write" v-show="showWrite">
      <layuiTitle :title="WriteState === 0 ? '添加资源站点设备配置' : WriteState === 1 ? '编辑资源站点设备配置' : '资源站点设备配置详情'"></layuiTitle>
...
import { GetResourceEquipmentList, GetResourceEquipmentInfo, DelEquipment, GetEquipmentTypeList } from 'api/api'
