  ...
  <div class="content">
    <div class="main" v-show="!showWrite">
      ...
      <el-table :data="tableList" v-loading="Loading" style="margin-top: 15px;">
        ...
        <el-table-column prop="capacity" label="容量/功率" width="80"></el-table-column>
        <el-table-column prop="powergenerationuser" label="发电机联系人" width=""></el-table-column>
        <el-table-column prop="powergenerationphone" label="发电机联系方式" width="" :show-overflow-tooltip="true"></el-table-column>
