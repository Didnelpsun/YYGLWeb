  ...
  <div class="content">
    <div class="main" v-show="!showWrite">
      ...
      <el-table :data="tableList" v-loading="Loading" style="margin-top: 15px;">
        ...
        <el-table-column prop="cableassembly" label="电池型号" width=""></el-table-column>
        <el-table-column prop="manufacturername" label="制造厂家" width=""></el-table-column>
        <el-table-column prop="capacity" label="容量" width=""></el-table-column>
        ...
        <el-table-column prop="statename" label="数据状态" width=""></el-table-column>
