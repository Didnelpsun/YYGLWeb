        ...
        <div class="el-table__body-wrapper is-scrolling-none">
          <table cellspacing="0" cellpadding="0" border="0" class="el-table__body" width="100%">
            ...
            <tr class="el-table__row">
              ...
              <td><div class="cell">
                <div v-if="WriteState == 0 && isTask === 0">动力及环境监测单元</div>
...
import {GetPowerAndEnvironmentInfo, GetTaskEquipmentPowerAndEnvironmentInfo, AddPowerAndEnvironment, EditPowerAndEnvironment,
  AddTaskEquipmentPowerAndEnvironment, EditTaskEquipmentPowerAndEnvironment} from 'api/SurveyManagement'
    ...
    SubAdd () {
      ...
      this.$refs.WriteForm.validate((vali, msg) => {
        if (!vali) {
          ...
          this.Loading = true
          this.$axios.post(AddPowerAndEnvironment, this.WriteData).then(res => {
            this.Loading = false
    ...
    SubEdit () {
      ...
      this.$refs.WriteForm.validate(vali => {
        if (!vali) {
          ...
          this.Loading = true
          this.$axios.put(EditPowerAndEnvironment, this.WriteData).then(res => {
            this.Loading = false
            if (res.errorCode !== '200') return this.$message.error(res.errorMessage)
            if (res.errorCode === '200') {
