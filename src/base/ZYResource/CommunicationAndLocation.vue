...
import {GetCommunicationAndLocationInfo, GetTaskEquipmentCommunicationAndLocationInfo, AddTaskEquipmentCommunicationAndLocation, EditTaskEquipmentCommunicationAndLocation} from 'api/SurveyManagement'
