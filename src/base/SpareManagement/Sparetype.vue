           ...
           <tr class="el-table__row">
              ...
              <td v-show="WriteState !== 2"><div class="cell">
                <el-form-item  class="form-item" prop="AreaList">
                  <el-cascader v-model="WriteData.AreaList" :props="areaProps" @change="changeArea(WriteData)" ref="csArea" clearable></el-cascader>
                </el-form-item>
              </div></td>
            ...
            <tr class="el-table__row">
              ...
              <td v-show="WriteState !== 2"><div class="cell">
                <el-form-item class="form-item" prop="typename">
                  <el-input v-model="WriteData.typename"  placeholder="请选择类型名称" clearable></el-input>
                </el-form-item>
              </div></td>
