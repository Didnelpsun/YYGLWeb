        ...
        <el-form :model="WriteData" :rules="Rules" v-loading="Loading" ref="WriteForm">
          <div class="el-table__body-wrapper is-scrolling-none">
            <table cellspacing="0" cellpadding="0" border="0" class="el-table__body" width="100%">
              ...
              <tbody>
              <!--设备类型-->
              <tr class="el-table__row el-table__row--striped" v-if="WriteState == 0">
                ...
                <td class="el-table_8_column_61">
                  <div class="cell">
                    ...
                    <div v-show="WriteState !== 2" prop="equipmenttypeIdArr">
                      <el-select v-model="WriteData.equipmenttypeIdArr" @change="selectDisposeCode" multiple placeholder="请选择" size="small">
                ...
                <td class="el-table_8_column_61">
                  <div class="cell">
                    ...
                    <div v-show="WriteState !== 2" prop="equipmenttype_id">
                      <el-select v-model="WriteData.equipmenttype_id" size="small">
                        <el-option v-for="(i,index) in EquipmentTypeList" :key="index" :label="i.name" :value="i.id"></el-option>
                      </el-select>
                    </div>
                  </div>
    ...
    SubAdd () {
      this.$refs.WriteForm.validate((vali, msg) => {
        if (!vali) {
          ...
          this.Loading = true
          this.$axios.post(AddEnergyResourceEquipment, Object.assign({}, {resource_id: this.resource_id,
            equipmenttype_id: this.WriteData.equipmenttypeIdArr,
            necessary: this.WriteData.necessary,
            manyrecords: this.WriteData.manyrecords})).then(res => {
            this.Loading = false
            if (res.errorCode === '200') {
    ...
    SubEdit () {
      this.$refs.WriteForm.validate(vali => {
        if (!vali) {
          ...
          this.$axios.put(UpdateEnergyResourceEquipment, Object.assign({}, {resource_id: this.resource_id,
            equipmenttype_id: this.WriteData.equipmenttype_id,
            necessary: this.WriteData.necessary,
            manyrecords: this.WriteData.manyrecords,
            createtime: this.WriteData.createtime,
            id: this.WriteData.id})).then(res => {
