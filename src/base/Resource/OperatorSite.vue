          ...
          <div class="el-table__body-wrapper is-scrolling-none">
            <table cellspacing="0" cellpadding="0" border="0" class="el-table__body" width="100%">
              ...
              <tr class="el-table__row">
                ...
                <td><div class="cell">
                  <div v-show="WriteState == 2">{{WriteData.systemcode}}</div>
              ...
              <tr class="el-table__row">
                ...
                <td><div class="cell">
                  <div v-show="WriteState == 2">{{WriteData.systemname}}</div>
                  <div v-show="WriteState !== 2">
              ...
              <tr class="el-table__row">
                ...
                <td><div class="cell">
                  <div v-show="WriteState == 2">{{WriteData.remark}}</div>
                  <div v-show="WriteState !== 2">
...
<script>
import {DictionaryInfoList, AddOperatorSite, GetOperatorSiteList, GetOperatorSiteInfo, DelOperatorSite, UpdateOperatorSite} from 'api/api'
...
export default {
  ...
  methods: {
    ...
    setImgList (list) {
      list.forEach((item) => {
        if (item.field_name === 'systemcode') this.ImgList1.push(item)
      })
    },
    ...
    OpenImgBox () {
      this.$refs.ImgBox.SetData('系统编码', 'systemcode', this.ImgList1)
