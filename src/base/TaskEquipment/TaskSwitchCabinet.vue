                ...
                <td>
                  <div class="cell">
                    ...
                    <el-form-item label-width="0" prop="number" class="form-item" v-show="WriteState !== 2">
                      <el-input v-model.number="tableData.number"></el-input>
                    </el-form-item>
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div class="cell">
                    ...
                    <el-form-item
                      ...
                      v-show="WriteState !== 2"
                    >
                      <el-input v-model="tableData.qualitycode"></el-input>
                    </el-form-item>
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div class="cell">
                    ...
                    <el-form-item label-width="0" prop="bodycode" class="form-item" v-show="WriteState !== 2" >
                      <el-input v-model="tableData.bodycode"></el-input>
                    </el-form-item>
                  </div>
                </td>
                ...
                <td>
                  <div class="cell">
                    ...
                    <el-form-item
                      ...
                      v-show="WriteState !== 2"
                    >
                      <el-input v-model.number="tableData.warehousenumber"></el-input>
                    </el-form-item>
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div class="cell">
                    ...
                    <el-form-item
                      ...
                      v-show="WriteState !== 2"
                    >
                      <el-input v-model="tableData.canopyarea"></el-input>
                    </el-form-item>
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div class="cell">
                    ...
                    <el-form-item
                      ...
                      v-show="WriteState !== 2"
                    >
                      <el-input v-model="tableData.canopymaterial"></el-input>
                    </el-form-item>
                  </div>
                </td>
                <td>
...
import {GetSwitchCabinetTaskEquipment, EditSwitchCabinetTaskEquipment} from 'api/SurveyManagement'
...
export default {
  ...
  methods: {
    ...
    OpenImgBox (s) {
      switch (s) {
        case 'longitude':
          ...
          break
        case 'manufacturer':
          this.$emit('fatherOpenImgBox', '制造厂商', 'manufacturer', this.manufacturerImgList)
          break
        case 'bodycode':
    ...
    validImgList () {
      ...
      if (!this.manufacturerImgList.length) {
        return this.$message.warning('制造厂商图片必须上传')
      }
  ...
  computed: {
    ImgList () {
      return this.longitudeImgList.concat(this.manufacturerImgList, this.bodycodeImgList, this.commonsiteImgList, this.canopyImgList)
    }
  },
  watch: {
    ImgList (val) {
